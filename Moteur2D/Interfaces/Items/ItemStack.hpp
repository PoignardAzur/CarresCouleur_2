...
namespace Menu
{
    ...
    class ItemStack : public ItemAbstraction
    {
        ...
        using ItemAlignPair = std::pair<uptrt<ItemAbstraction>, Alignement>;
        ...
        void addItem(uptrt<ItemAbstraction> item, Alignement align);
        ...
        std::vector<std::pair<uptrt<ItemAbstraction>, Alignement>> m_items;
